...
$PendingUpdates = Get-PendingUpdate -Computername $ComputerName

write-output "Exporting data to: $($exportPath)"
$PendingUpdates | select ComputerName,KB,IsDownloaded,Title,MsrcSeverity | export-csv -Path $exportPath -NoTypeInformation
